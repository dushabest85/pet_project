...
private:
    void connect(const std::string& host, const std::string& port)
    {
        ...
        _connection = std::make_unique<bredis::Connection<socket_t>>(&_socket);
...
int main()
{
    SimpleRedisClient client("10.145.1.150", "6385");
    ...
    std::cout << "Value for 'mykey1': " << value1 << std::endl;
    ...
    std::cout << "Value for 'mykey2': " << value2 << std::endl;
